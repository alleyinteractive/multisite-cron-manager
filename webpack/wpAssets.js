...
/**
 * Build JSON object containing a map of asset names to the output filename
 * of that asset (including hash). Assets are organized by entry point.
 *
 * @param {string} mode - The export mode (development or production).
 * @return {string} JSON object containing asset name => filename mapping.
 */
